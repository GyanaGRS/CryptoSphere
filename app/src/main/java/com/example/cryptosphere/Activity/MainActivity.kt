package com.example.cryptosphere.Activity
...
import com.example.cryptosphere.Adapter.CryptoAdapter
import com.example.cryptosphere.Adapter.StockAdapter
import com.example.cryptosphere.Model.Model
import com.example.cryptosphere.databinding.ActivityMainBinding
...
//
    private fun StockList() {
        ...
        binding.stockView.isNestedScrollingEnabled = false
    ...
    private fun CryptoList() {
        ...
        binding.cryptoView.adapter = CryptoAdapter(cryptoList)
    }
}
